          ...
          {loading ? (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="font-bold truncate text-sm text-white">
              ...
              {match.shelter_rating && <Star size={14} className="fill-yellow-400 text-yellow-400 shrink-0" />}
            </button>
          ))}
        </div>
      </div>
          ...
          <>
            <div className="p-4 border-b border-white/5 bg-app-card/80 backdrop-blur-md flex items-center justify-between sticky top-0 z-10">
              <div className="flex items-center gap-3">
                <button onClick={() => setActiveMatch(null)} className="md:hidden p-2 hover:bg-white/10 rounded-full text-white">
                  <ArrowLeft size={20} />
                </button>
              ...
              {effectiveRole === 'ADOPTER' && (
                ...
                >
                  <Star size={16} className={activeMatch.shelter_rating ? "fill-yellow-400 text-yellow-400" : ""} />
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {messages.map((msg) => {
                ...
                const senderName = isMe ? 'Вы' : (msg.sender?.name || 'Пользователь');
